...
Project directory: /tmp/auboris-pulse

Task metadata:
- Asana task gid: 1217494074751003
- Asana task name: GB GW4 C1497
- Asana URL: https://app.asana.com/1/1208304498069546/project/1213586227413017/task/1217494074751003
- App name: Auboris Pulse
- Company: AUBORIS
- Domain: https://auboris.casa
- Package: auboris.strategy.auborispulse
- Prefix: ZVOPD
- Type: service
...
База знаний: страница с экспертными статьями по лидерству, управлению изменениями и анализу рыночной конъюнктуры (минимум 3 статьи).  
...
2. Do not create project-local agent instruction files inside /tmp/auboris-pulse.
