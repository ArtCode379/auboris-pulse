package auboris.strategy.auborispulse.ui.composable.approot
...
import auboris.strategy.auborispulse.ui.composable.navigation.AppNavHost
import auboris.strategy.auborispulse.ui.composable.navigation.NavRoute
import kotlin.reflect.KClass

private val navigationItems: List<BottomNavItem> = listOf(
    BottomNavItem(
        titleRes = R.string.zvopd_bottom_bar_nav_item_home_title,
        icon = Icons.Default.Home,
        route = NavRoute.Home
    ),
    BottomNavItem(
        titleRes = R.string.zvopd_bottom_bar_nav_item_bookings_title,
        icon = Icons.Default.Book,
        route = NavRoute.Bookings
    ),
    BottomNavItem(
        titleRes = R.string.zvopd_bottom_bar_nav_item_settings_title,
